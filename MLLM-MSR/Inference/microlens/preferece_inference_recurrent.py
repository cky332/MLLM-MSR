...
ui_pair_path = "/home/chenkuiyun/MLLM/MLLM-MSR/data/MicroLens-50k/Split/user_items_negs.tsv"
data = []
...
title_df = pd.read_csv("/home/chenkuiyun/MLLM/MLLM-MSR/data/MicroLens-50k/MicroLens-50k_titles.csv")
visual_df = pd.read_csv("/home/chenkuiyun/MLLM/image_summary.csv")
